...
const Footer = () => {
  return (
    <footer className="text-center lg:text-left bg-[#03364D] text-white">
  <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
    <div className="mr-12 hidden lg:block">
      <span>Conectate con nosotros, te dejamos nuestras redes sociales:</span>
    </div>
  ...
  <div className="mx-6 py-10 text-center md:text-left">
    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      <div className="">
        ...
        <div className='flex justify-center items-center bg-white/60 rounded-2xl backdrop-blur-sm'> 
            <MdLocationCity size={100} className='logo text-sky-800'  />
            <h1 className='text-amber-400 drop-shadow  '>H<span className='uppercase text-sky-800 '>ogari.</span></h1>
        </div>
      
       <p className='text-center'>
          Hogari es una empresa ficticia dedicada a la venta y renta de bienes raices.
        </p>
      </div>
      <div className="">
  ...
  <div className="text-center p-6 bg-[#022230]">
    <span>	&#169; 2022 Copyright:</span>
    <a className="text-white font-semibold" href="/"> Hogari.</a>
  </div>
</footer>
  )
}
